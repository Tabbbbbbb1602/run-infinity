...
/// trạng thái được đẩy lên trên GameManager khi người chơi chết.
/// </summary>
public class GameOverState : AState
{
    ...
    public override void Enter(AState from)
    {
        ...
        //Debug.Log(PlayerData.instance.AnyMissionComplete());
	...
	public void OpenLeaderboard()
	{
        ...
        //Hiển thị màn hình chơi lại
		fullLeaderboard.displayPlayer = true;
        //Update name character
