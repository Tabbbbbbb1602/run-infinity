...
/// Được đẩy lên trên GameManager trong khi chơi trò chơi. Đảm nhận việc khởi tạo tất cả giao diện người dùng và khởi động TrackManager
/// Ngoài ra sẽ chăm sóc vệ sinh khi rời khỏi trạng thái đó.
/// </summary>
public class GameState : AState
{
    ...
    {
        //Ẩn đi màn hình bấm vào game over
    ...
    public void StartGame()
    {
        ...
        //Debug.Log(trackManager.isRerun);
        //khi va chet thi cong mau len 1 neu su dung tien
    ...
    public void Pause(bool displayMenu = true)
	{
        ...
        //kiểm tra xem chúng ta chưa hoàn thành HOẶC nếu chúng ta chưa tạm dừng (vì điều đó sẽ gây rối trạng thái)
	...
	public void QuitToLoadout()
	{
        ...
        // Được sử dụng bởi menu tạm dừng để quay lại ngay lập tức để tải, hủy mọi thứ.
        Time.timeScale = 1.0f;
		AudioListener.pause = false;
		trackManager.End();
	...
	IEnumerator WaitForGameOver()
	{
        ...
        //Debug.Log(currentModifier.OnRunEnd(this));
    ...
    void TutorialCheckObstacleClear()
    {
        ...
        //Debug.Log(trackManager.characterController.tutorialWaitingForValidation);
        ...
        Debug.Log(ratio);
        Debug.Log(nextObstaclePosition);
