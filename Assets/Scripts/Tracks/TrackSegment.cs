...
/// Điều này xác định một "đoạn" của bản nhạc. Cái này được gắn vào nhà lắp ghép và chứa dữ liệu như những chướng ngại vật nào có thể xuất hiện trên đó.
/// Nó cũng xác định các vị trí trên đường đua mà chướng ngại vật có thể xuất hiện. Nhà lắp ghép được đặt vào danh sách ThemeData.
/// </summary>
public class TrackSegment : MonoBehaviour
{
    ...
    // Tương tự như GetPointAt nhưng sử dụng tham số nội suy theo đơn vị thế giới thay vì 0 đến 1.
    ...
    // Tham số nội suy t được kẹp giữa 0 và 1.
